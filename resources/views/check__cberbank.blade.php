        ...
        <div class="col-12">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Проверка оперции Сбербанка</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="container py-5">
    <div class="row align-items-md-stretch justify-content-center">
        <div class="col-12">
            <form method="post" action="{{ route('atc_clients_cberbank_post') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-9">
                        <input class="form-control form-control-lg" type="file" name="excel_file" id="floatingInputGrid">
                    </div>
                    <div class="col-1">
                        <select class="form-select form-select-lg" id="select_input" name="percent" aria-label="Floating label select example">
                        </select>
                    </div>
